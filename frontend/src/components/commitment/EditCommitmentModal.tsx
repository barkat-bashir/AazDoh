...
import { Commitment, commitmentApi, CommitmentCategory, CommitmentPriority, CommitmentVisibility, DayPhase } from '../../api/commitmentApi';
import { partnershipApi } from '../../api/partnershipApi';
import { useAuth } from '../../context/AuthContext';
import { useToast } from '../../context/ToastContext';
import { Clock, Flame, Users, Lock, Target, Zap, Plus, X, ChevronDown, Check, Sunrise, Sun, Moon } from 'lucide-react';
...
export const EditCommitmentModal: React.FC<EditCommitmentModalProps> = ({
  ...
  useEffect(() => {
    if (isOpen && commitment) {
      ...
      setDayPhase(commitment.dayPhase || null);
